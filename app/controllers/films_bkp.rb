  ...
  def index
    ...
    info.each { |info1|
      ...
      mov_name.each { |info2|
        ...
        Films.create(:name => info3[1],:release_date => info3[2],:thumbnail_image => info3[0]) unless Films.where(:name => info3[1]).exists?
        hyperlink = "http://i.indiafm.com/img/firstlook/posters/"+info3[0]+".jpg"
        image = File.new("/home/ubuntu/muvi.in/public/thumbnails/"+info3[0]+".png","wb")
        begin
